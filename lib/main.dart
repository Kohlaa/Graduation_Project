...
import 'package:garduation/modules/qr_scanner/qr_code_bloc/qr_cubit.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<GradCubit>(create: (BuildContext context) => GradCubit()..getParking()),
        BlocProvider<QrCodeCubit>(create: (BuildContext context) => QrCodeCubit()),
